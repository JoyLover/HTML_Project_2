...
<!--input text area and two buttons-->
    <div class="container">
        <form id="ask-form" role="form" action="../database/ask_question.php" method="post" onSubmit="return check();">
            <div class="row">
            ...
            <div id="remain-ch-div" class="d-flex justify-content-end">
                <span id="rm-ch" class="remain-ch">500</span><span class="remain-ch">&nbsp;characters left&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </div>
