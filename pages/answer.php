...
?>
    ...
    <div class="container">
        ...
        <form role="form" action="../database/answer_question.php" method="post" onSubmit="return check();">
            ...
            <div id="answer-remain-ch" class="d-flex justify-content-end">
                <span id="answer-rm-ch" class="answer-rm-num">500</span><span class="answer-rm-num">&nbsp;characters left&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </div>
